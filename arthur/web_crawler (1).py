...
HEADER_REQUISICAO_FIXO = OrderedDict([
    ...
    ("cookie", "_gid=GA1.3.364041001.1773191305; csrftoken=K2uMqb1gmMDutd2bHdSBoHUxh0N8ysf1; sessionid=.eJxVjMEOgjAQRP-lZ9NQ2C6tR-98Q7Pdbi1qIKFwMv67kHDQ48x7M28VaFtL2KosYUzqqsBi16vLbx-JnzIdMD1ous-a52ldxqgPRZ-06mFO8rqd7t9BoVr2dUQi44D7xgoTmzYLNx1INEQs1mGKe0rgbULMPiN4Bo-OW2MArVWfL6bzOQ0:1w08JP:WZTbrd0iBym-Q8nDj_D0T_PcZhshYrtRPqP1VYCzivI; cf_clearance=7PX4W9_RO9E0m6GDuawwMYv3AE0fSDse1kS4D6gFg90-1773258422-1.2.1.1-01oe_LmJkums49iSJUnY4dRaqdURdOwD3ig_TrMveEXfs7Dd9WjMV8H.IQjDy7wtJ4wdJxSw9c.euWJSVDSwHeoIn9dJMd_hzFRcfkdiLB3wtPxE3aBh8AK5yjrQIHf.pgo9Vz6UXX2rEF5oICp.XuG5hiw8XnuUFUzhrKOYhG_GwYxQwa3TaNlPYLziprCesidOqkGn3M1MN9PfgCQ7uaS8pK1g_l4GY8TOCzS_5gs; _gat_gtag_UA_64312596_1=1; _ga_DDXNJ6N67S=GS2.1.s1773257382$o2$g1$t1773258441$j46$l0$h0; _ga=GA1.3.1934611308.1773191305"),
    ("priority", "u=0, i"),
...
# ─────────────────────────────────────────────────────────────────────────────
# LOGIN AUTOMÁTICO — ETAPA DESATIVADA (comentada)
# ─────────────────────────────────────────────────────────────────────────────
...
def _iniciar_sessao_autenticada(
    ...
    # Etapa de login desativada (comentada)

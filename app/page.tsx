...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <nav className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2 min-w-0">
              <div className="bg-gradient-to-br from-emerald-500 to-green-700 p-1.5 sm:p-2 rounded-lg flex-shrink-0">
                <GraduationCap className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
              </div>
              <span className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-emerald-600 to-green-700 bg-clip-text text-transparent truncate">
                MedMind
              </span>
            </div>
            {/* Desktop nav */}
            <div className="hidden md:flex gap-2 lg:gap-4 items-center flex-shrink-0">
              <Link href="#features" className="px-3 py-2 text-gray-700 hover:text-emerald-600 transition text-sm lg:text-base">
                Funcionalidades
              </Link>
              <Link href="#pricing" className="px-3 py-2 text-gray-700 hover:text-emerald-600 transition text-sm lg:text-base">
                Planos
              </Link>
              <Link href="/login" className="px-3 py-2 text-gray-700 hover:text-emerald-600 font-medium transition text-sm lg:text-base">
                Entrar
              </Link>
              <Link href="/login" className="px-4 lg:px-6 py-2 bg-gradient-to-r from-emerald-500 to-green-700 text-white rounded-lg hover:from-emerald-600 hover:to-green-800 transition shadow-lg shadow-emerald-500/30 text-sm lg:text-base font-medium">
                Começar Grátis
              </Link>
            </div>
            {/* Mobile menu button */}
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-3 pt-3 border-t border-gray-200 flex flex-col gap-1">
              ...
              <Link href="/login" onClick={() => setMobileMenuOpen(false)} className="mx-4 mt-2 py-3 bg-gradient-to-r from-emerald-500 to-green-700 text-white rounded-lg text-center font-medium min-h-[44px] flex items-center justify-center">
                Começar Grátis
              </Link>
            </div>
          )}
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4">
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute top-10 left-4 w-40 h-40 sm:w-56 sm:h-56 md:w-72 md:h-72 bg-emerald-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob"></div>
          <div className="absolute top-32 right-4 w-40 h-40 sm:w-56 sm:h-56 md:w-72 md:h-72 bg-green-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-2000"></div>
          <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-40 h-40 sm:w-56 sm:h-56 md:w-72 md:h-72 bg-teal-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-4000"></div>
        </div>

        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-white/80 backdrop-blur-sm rounded-full text-xs sm:text-sm font-medium text-emerald-600 mb-4 sm:mb-6 shadow-sm">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight px-1">
              ...
              <span className="block bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 bg-clip-text text-transparent mt-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center px-2">
              <Link href="/login" className="group px-6 sm:px-8 py-3.5 sm:py-4 bg-gradient-to-r from-emerald-500 to-green-700 text-white rounded-xl text-base sm:text-lg font-semibold hover:from-emerald-600 hover:to-green-800 transition shadow-xl shadow-emerald-500/30 flex items-center justify-center gap-2 min-h-[48px]">
                Começar Agora
            ...
            <div className="mt-10 sm:mt-14 md:mt-16 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 md:gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-white/60 backdrop-blur-sm p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg">
                <div className="text-2xl sm:text-3xl font-bold text-green-700 mb-1 sm:mb-2">500+</div>
                <div className="text-xs sm:text-sm text-gray-600">Cases Clínicos</div>
              </div>
              <div className="bg-white/60 backdrop-blur-sm p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg">
                <div className="text-2xl sm:text-3xl font-bold text-teal-600 mb-1 sm:mb-2">50+</div>
                <div className="text-xs sm:text-sm text-gray-600">Especialidades</div>
              </div>
              <div className="bg-white/60 backdrop-blur-sm p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg">
                <div className="text-2xl sm:text-3xl font-bold text-emerald-700 mb-1 sm:mb-2">24/7</div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3 sm:mb-4 px-2">
              ...
              <span className="block text-emerald-600">estudar medicina</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-10 sm:mb-16">
            ...
            <div className="group bg-gradient-to-br from-emerald-50 to-green-50 p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border-2 border-emerald-100 hover:border-emerald-300 transition-all hover:shadow-xl">
              <div className="bg-gradient-to-br from-emerald-500 to-green-700 w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
            ...
            {/* Feature 2 - Questões */}
            <div className="group bg-gradient-to-br from-teal-50 to-emerald-50 p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border-2 border-teal-100 hover:border-teal-300 transition-all hover:shadow-xl">
              <div className="bg-gradient-to-br from-teal-600 to-emerald-600 w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
            ...
            <div className="group bg-gradient-to-br from-emerald-50 to-teal-50 p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border-2 border-emerald-100 hover:border-emerald-300 transition-all hover:shadow-xl">
              <div className="bg-gradient-to-br from-emerald-600 to-teal-600 w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
            ...
            <div className="group bg-gradient-to-br from-green-50 to-teal-50 p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border-2 border-green-100 hover:border-green-300 transition-all hover:shadow-xl">
              <div className="bg-gradient-to-br from-green-700 to-teal-600 w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
            ...
            <div className="group bg-gradient-to-br from-teal-50 to-green-50 p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border-2 border-teal-100 hover:border-teal-300 transition-all hover:shadow-xl">
              <div className="bg-gradient-to-br from-teal-600 to-green-700 w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-12 sm:py-16 md:py-24 bg-gradient-to-br from-gray-50 to-emerald-50">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3 sm:mb-4 px-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
            {/* Plano Gratuito */}
            <div className="bg-white p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-xl border-2 border-gray-200 hover:border-emerald-200 transition-all">
            ...
            {/* Plano Premium */}
            <div className="bg-gradient-to-br from-emerald-600 to-green-700 p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-2xl border-4 border-emerald-400 relative overflow-hidden">
              {/* Badge */}
              ...
              <div className="relative z-10">
                <div className="text-center mb-8">
                  ...
                  <p className="text-emerald-100">Para estudantes sérios e profissionais</p>
                </div>
                ...
                <Link
                  href="/login"
                  className="block w-full text-center px-6 py-3 bg-white text-emerald-700 rounded-xl font-semibold hover:bg-gray-50 transition shadow-xl"
                >
                  Assinar Premium
                </Link>
              </div>
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-emerald-700 via-green-700 to-teal-700">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center">
              <Link
                href="/login"
                className="px-8 py-4 bg-white text-emerald-700 rounded-xl text-lg font-semibold hover:bg-gray-50 transition shadow-xl flex items-center justify-center gap-2"
              >
                Começar Agora
